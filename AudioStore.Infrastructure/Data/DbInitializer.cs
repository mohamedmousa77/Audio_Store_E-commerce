    ...
    private static async Task SeedProductsAsync(AppDbContext context, ILogger logger)
    {
        ...
        var products = new List<Product>
        {
            ...
            new Product
            {
                ...
                Specifications = "Featuring a genuine leather head strap and premium earcups, these headphones deliver superior comfort for those who like to enjoy endless listening. It includes intuitive controls designed for any situation.",
                Price = 2999.00m,
            ...
            new Product
            {
                ...
                Specifications = "These headphones have been created from scratch with premium materials. Their design is both functional and stylish, with a focus on delivering the best possible listening experience.",
                Price = 1750.00m,
                CategoryId = headphonesCategory.Id,
                StockQuantity = 20,
            ...
            new Product
            {
                ...
                Specifications = "The XX59 headphones combine stylish design with premium audio quality. They feature soft ear cushions and a lightweight design for extended listening sessions.",
                Price = 899.00m,
                CategoryId = headphonesCategory.Id,
                StockQuantity = 30,
            ...
            new Product
            {
                ...
                Specifications  = "Connect via Bluetooth or nearly any wired source. This speaker features optical, digital coaxial, USB Type-B, stereo RCA, and stereo XLR inputs, allowing you to have up to five wired source devices connected for easy switching.",
                Price = 4500.00m,
            ...
            new Product
            {
                ...
                Specifications  = "Reap the advantages of a flat diaphragm tweeter cone. This provides a fast response rate and excellent high frequencies that lower tiered bookshelf speakers cannot provide.",
                Price = 3500.00m,
                CategoryId = speakersCategory.Id,
                StockQuantity = 12,
            ...
            new Product
            {
                ...
                Specifications  = "Experience unrivalled stereo sound thanks to innovative acoustic technology. With improved ergonomics designed for full day wearing, these revolutionary earphones have been finely crafted to provide you with the perfect fit.",
                Price = 599.00m,
